...
export const PLAYBOOKS: Playbook[] = [
  ...
  },
  {
    ...
    summary:
      "Group keywords by intent and map each cluster to an existing or proposed page.",
    ...
    decisionRules: [
      {
        ...
        action:
          "Split if SERP intent or page type differs; do not cluster on lexical similarity alone",
      },
      {
        id: "prefer-existing",
  ...
  },
  {
    ...
    title: "Local SEO",
    summary:
      "Audit a Google Business Profile against local competitors and map Maps visibility.",
  ...
  },
  {
    ...
    summary:
      "Find realistic pages that might reference a linkable asset. Outreach send is T3.",
  ...
  },
  {
    ...
    summary:
      "Analyze one competitor deeply enough to decide what to learn from, avoid, or outrank.",
  ...
  },
  {
    ...
    summary:
      "Who is winning this SEO market, what content is working, and where the openings are.",
  ...
  },
  {
    ...
    title: "Project setup",
    summary:
      "Capture business, goal, positioning, voice, competitors, and key pages once.",
    ...
    decisionRules: [
      {
        ...
        action:
          "Refuse refresh_content, create_page, generate_ymyl, generate_affiliate",
      },
      {
        id: "t4",
  ...
  },
  {
    ...
    title: "Local GBP",
    summary:
      "Manage a Google Business Profile within quota. AI citation gap over rank tracking. Never generate reviews or city×service pages.",
    inputs: [
      {
        name: "locations",
        type: "GbpLocation[]",
    ...
    decisionRules: [
      {
        ...
        when: "writing GBP",
        action:
          "Token-bucket 10 edits/min/profile, 300 QPM; degrade to read-only without approval",
      },
      {
        id: "no-title",
  ...
  },
  {
    ...
    summary:
      "Mention-first. Branded web mentions correlate 0.656–0.709 with AI visibility vs 0.266–0.326 for Domain Rating.",
