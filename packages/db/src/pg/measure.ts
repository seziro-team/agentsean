...
/** Phase 7 — experiments, claims, reconciliation waterfall. Dual-dialect with sqlite/measure.ts. */
...
export const dataAnomalies = pgTable(
  "data_anomalies",
  {
    id: text("id").primaryKey(),
...
export const reconciliationWaterfall = pgTable(
