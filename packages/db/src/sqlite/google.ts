...
/** Phase 2 — Google connections. Dual-dialect; keep in lockstep with pg/google.ts. */
...
export const gscDaily = sqliteTable(
  "gsc_daily",
  {
    id: text("id").primaryKey(),
    siteId: text("site_id")
...
export const gscPageDaily = sqliteTable(
  "gsc_page_daily",
  {
    id: text("id").primaryKey(),
    siteId: text("site_id")
...
export const ga4Daily = sqliteTable(
  "ga4_daily",
  {
    id: text("id").primaryKey(),
    siteId: text("site_id")
...
export const ga4LandingDaily = sqliteTable(
  "ga4_landing_daily",
  {
    id: text("id").primaryKey(),
    siteId: text("site_id")
...
export const cruxRecords = sqliteTable(
  "crux_records",
  {
    id: text("id").primaryKey(),
    siteId: text("site_id")
...
export const psiAudits = sqliteTable(
  "psi_audits",
  {
    id: text("id").primaryKey(),
    siteId: text("site_id")
...
export const googleIncidents = sqliteTable(
  "google_incidents",
  {
    id: text("id").primaryKey(),
    number: text("number"),
...
export const googleChangepoints = sqliteTable(
  "google_changepoints",
  {
    id: text("id").primaryKey(),
...
export const gscGa4Reconciliation = sqliteTable(
...
export const siteVerifications = sqliteTable(
  "site_verifications",
  {
    id: text("id").primaryKey(),
    siteId: text("site_id")
